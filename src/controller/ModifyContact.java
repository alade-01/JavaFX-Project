...
/**
 *This class is used to manage the FXML modifyContact file.
 *
 * @author  CyberDine
 * @since   2021-04-11
 */
public class ModifyContact implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            //Line of code to select several people at the same time.
    ...
    private void saveModifyContact(ActionEvent actionEvent) throws SQLException, IOException {
        ...
        if (TableView.getSelectionModel().getSelectedItem() != null) {
            ...
            if (tel.isEmpty()){
                ...
                /*else{
                    userSexeSave = sexeUsers;
                }*/
                Person selectedPerson = TableView.getSelectionModel().getSelectedItem();

                //System.out.println(sexeUsers);
                //Global variable.
